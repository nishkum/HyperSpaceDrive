...
namespace hyperSpaceDrive
{
    ...
    public partial class GamePage : PhoneApplicationPage
    {
        ...
        int score =0, incr = 50, maxScore, mistY = 0;

        float scale = 0.6f;
        int fheight = 200, maxNoOfObjects = 8, spaceToAccomodate = 10,lower=50,upper=SharedGraphicsDeviceManager.Current.GraphicsDevice.Viewport.Height-200;
            ...
            foreach (TouchLocation touch in touchCollection)
            {
                if ((touch.State == TouchLocationState.Pressed) || (touch.State == TouchLocationState.Moved))
                {
                    if(touch.Position.X<down.Width  & touch.Position.Y>-down.Height+SharedGraphicsDeviceManager.Current.GraphicsDevice.Viewport.Height){
                        ...
                        vertices[1].Position.Y=vertices[0].Position.Y = SharedGraphicsDeviceManager.Current.GraphicsDevice.Viewport.Height - fheight;
                    }
        ...
        private void OnDraw(object sender, GameTimerEventArgs e)
        {
            ...
            spriteBatch.DrawString(content.Load<SpriteFont>("SpriteFont1"), "Score:"+score.ToString(), new Vector2(10, 10), Color.White);
            spriteBatch.DrawString(content.Load<SpriteFont>("SpriteFont1"), "Life:"+spaceToAccomodate.ToString(),
                                                    new Vector2(SharedGraphicsDeviceManager.Current.GraphicsDevice.Viewport.Width-120, 10), Color.White);
